...
function App() {
  return (
    <div className="App" class="flex justify-center items-center h-screen bg-indigo-600">
      <div class="w-96 p-6 shadow-lg rounded-md bg-slate-300">
      <Header></Header>

      <form>
        <input type='text' placeholder='Username..' class="mt-3 border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-grey-600"/>
        ...
        <button class="mt-3 w-full bg-blue-900 border-2 rounded-md border-white hover:bg-transparent text-white hover:text-black text-xl">Enter</button>
      </form>
      </div>
    </div>
  );
